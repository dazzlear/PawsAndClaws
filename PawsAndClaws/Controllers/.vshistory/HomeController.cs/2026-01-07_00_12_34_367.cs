...
namespace PawsAndClaws.Controllers
{
    public class HomeController : Controller
    {
        ...
        // ? CHANGE: Use id instead of name (so Adoption can post PetId reliably)
        public async Task<IActionResult> Details(int id)
        {
            ...
            // Optional: if description is empty, you can force a placeholder
        ...
        // 3. SAMPLE DATA SOURCE (same as yours, but now includes Id + optional Description)
